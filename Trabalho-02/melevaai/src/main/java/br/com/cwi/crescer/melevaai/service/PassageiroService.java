...
public class PassageiroService {
    ...
    public Passageiro criarPassageiro(CriarPassageiroRequest request) throws JaCadastradoException, ValidacaoNegocioException {

        Passageiro passageiro = PassageiroMapper.toDomain(request);

        if (repository.findByCpf(passageiro.getCpf()) != null) {
    ...
    public void depositarCredito(double valor, String cpf) throws SemSaldoException, NaoCadastradoException {
        ...
        Passageiro passageiro = consultarPassageiroPorCpf(new CPF(cpf));
    ...
    public PassageiroResponse consultarPassageiroResponsePorCpf(final String cpf) throws NaoCadastradoException {
        ...
        final Passageiro passageiro = consultarPassageiroPorCpf(new CPF(cpf));

        return toResponse(passageiro);
    }

    public Passageiro consultarPassageiroPorCpf(final CPF cpf) throws NaoCadastradoException {

        final Passageiro passageiro = repository.findByCpf(cpf);
