...
public class VeiculoController {
    ...
    public void cadastrarVeiculos(@RequestBody @Valid CriarVeiculoRequest request) throws ValidacaoNegocioException, MotoristaNaoHabilitadoException, MotoristaComVeiculoException, NaoCadastradoException {
